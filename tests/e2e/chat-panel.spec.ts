...
// epic, Slice 2) opens from a real Dashboard row and accepts input, without
...
test("the contextual chat panel opens from a Dashboard row and accepts input", async ({ page }) => {
  await page.goto("/");
